            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">{{ $vehicle->name }} ({{ $vehicle->plate_no }}) - Documents</h4>
                        <ol class="breadcrumb">
                            <li><a href="/home">Home</a></li>
                            <li><a href="/home">Vehicles</a></li>
                            <li><a href="/vehicles/{{ $vehicle->uniqid }}">{{ $vehicle->plate_no }}</a></li>
                    	...
                    	@foreach($vehicle->documents as $doc)
	                        ...
	                        <div class="col-sm-6 col-lg-3 col-md-4">
	                            <div class="gal-detail thumb">
	                                ...
	                                <a href="/documents/{{$doc->id}}/delete" class="text-danger">Delete</i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('vehicle.documents.store', ['vehicle' => $vehicle]) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Ex. RC Book">
                                                    </div>
                                                </div>
                                            </div>
