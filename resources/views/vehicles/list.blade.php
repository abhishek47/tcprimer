 ...
 <div class="row">
                ...
                <div class="col-md-4">
                        <div class="widget-panel widget-style-2 bg-white">
                            ...
                            <h2 class="m-0 text-dark counter font-600">{{ $vehicle->name }} <br><span style="font-size: 16px;font-weight: bold;" id="vehicle-status-{{$vehicle->id}}" class="text-danger hidden-xs"></span> </h4></h2>
