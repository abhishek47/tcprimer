            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title large">{{ $vehicle->name }} : Speed Reports <span id="vehicle-status" class="text-danger"></span></h4>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <p class="text-dark m-b-5 font-13" style="font-weight: bold;" >Weekly Average : <span id="week-average">0</span> Km/h
                            </p>
                     ...
                     <div class="col-lg-6">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b>Speeding Comparison (in %)</b></h4>
                ...
                <div class="col-lg-6">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b>Daily Report <small id="daily-date-label">{{ (new DateTime())->format("Y-m-d") }}</small></b>
                        	</h4>
                        	<select class="form-control report-date-selector" id="daily-date" onchange="dailyChart()">
                             ...
                             <p class="text-dark m-b-5 font-13" style="font-weight: bold;" >Daily Average : <span id="daily-average">0</span> Km/h
                            </p>
                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b>Last 30 Days Report</b></h4>
                             <p class="text-dark m-b-5 font-13" style="font-weight: bold;" >Monthly Average : <span id="month-average">0</span> Km/h
                            </p>
...
@section('js')
	...
	<script src="/js/speedreports.js"></script>

	@include('vehicles.reports.setup.speed.week')
	@include('vehicles.reports.setup.speed.daily')
	@include('vehicles.reports.setup.speed.comparison')
	@include('vehicles.reports.setup.speed.monthly')
