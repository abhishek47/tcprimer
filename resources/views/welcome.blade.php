...
<html lang="en">
    <head>
        ...
        <title>TechnoCoup | Leveraging Innovation</title>
        ...
        <!-- Owl Carousel CSS -->
        <link href="/welcome/css/owl.carousel.css" rel="stylesheet">
        <link href="/welcome/css/owl.theme.default.min.css" rel="stylesheet">
    ...
    <body data-spy="scroll" data-target="#navbar-menu">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand logo" href="index.html">
                       <a href="/home" class="logo hidden-xs"><img src="/images/logo.png" width="60px;" />   Techno<span class="text-custom">C</span>oup <small style="font-size: 11px;text-transform: none;">TDrive</small>
                    </a>
                ...
                <!-- menu -->
                <div class="navbar-collapse collapse" id="navbar-menu" style="margin-top: 6px;">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="#features" class="nav-link">TDrive</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('register') }}" class="btn btn-white-bordered navbar-btn">Create Account</a>
                        </li>
                    </ul>
                        ...
                        <div class="home-fullscreen">
                            <div class="full-screen">
                                <div class="home-wrapper home-wrapper-alt">
                                    ...
                                    <h2 class="font-light text-white"> TechnoCoup <b style="text-transform: none;">TDrive</b> is a GPS Tracking system</h2>
                                    <h4 class="text-white">TechnoCoup TDrive is a fully featured premium admin template built on top of awesome Bootstrap 3.3.7, modern web technology HTML5, CSS3 and jQuery. It has many ready to use hand crafted components. </h4>
                                    <a href="//www.youtube.com/watch?v=XSGBVzeBUbk" data-lity class="btn btn-custom"><i class="fa fa-play-circle"></i> Watch Video</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section" id="features">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h3 class="title">The <b>TDrive</b> is the first version of GPS system from TechnoCoup</h3>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sm-offset-1">
                        <img src="/welcome/images/mac_1.png" alt="img" class="img-responsive m-t-20">
                    </div>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <img src="/welcome/images/mac_2.png" alt="img" class="img-responsive">
                    </div>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sm-offset-1">
                        <img src="/welcome/images/mac_3.png" alt="img" class="img-responsive">
                    </div>
                        ...
                        <div class="owl-carousel text-center">
                            <div class="item">
                                <div class="testimonial-box">
                                    ...
                                    <img src="/welcome/images/user.jpg" class="testi-user img-circle" alt="testimonials-user">
                                    <p>- General Manager, Mahindra</p>
                                </div>
                            </div>
                            <div class="item">
                                <div class="testimonial-box">
                                    ...
                                    <img src="/welcome/images/user2.jpg" class="testi-user img-circle" alt="testimonials-user">
                                    <p>- Global Manager, GE Electric</p>
                                </div>
                            </div>
                            <div class="item">
                                <div class="testimonial-box">
                                    ...
                                    <img src="/welcome/images/user3.jpg" class="testi-user img-circle" alt="testimonials-user">
                                    <p>- TechnoCoup User</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <article class="pricing-column col-lg-4 col-md-4">
                                <div class="inner-box">
                                    <div class="plan-header text-center">
                                        ...
                                        <h2 class="plan-price">&#8377 330</h2>
                            ...
                            <article class="pricing-column col-lg-4 col-md-4">
                                <div class="inner-box active">
                                    <div class="plan-header text-center">
                                        ...
                                        <h2 class="plan-price">&#8377 580</h2>
                                        <div class="plan-duration">Per License</div>
                                    </div>
                                    <ul class="plan-stats list-unstyled">
                                        <li> <i class="pe-7s-server"></i>Number of end products <b>1</b></li>
                            ...
                            <article class="pricing-column col-lg-4 col-md-4">
                                <div class="inner-box">
                                    <div class="plan-header text-center">
                                        ...
                                        <h2 class="plan-price">&#8377 1180</h2>
                                        <div class="plan-duration">Per License</div>
                                    </div>
                                    <ul class="plan-stats list-unstyled">
                                        <li> <i class="pe-7s-server"></i>Number of end products <b>1</b></li>
        ...
        <section class="section p-t-0" id="clients">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h3 class="title">Trusted by Industry Standards</h3>
                        <p class="text-muted sub-title">The clean and well commented code allows easy customization of the theme.It's <br/> designed for describing your app, agency or business.</p>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row text-center">
                    <div class="col-sm-12">
                        <ul class="list-inline client-list">
                            <li><a href="" title="Microsoft"><img src="/welcome/images/clients/microsoft.png" alt="clients"></a></li>
                            <li><a href="" title="Google"><img src="/welcome/images/clients/google.png" alt="clients"></a></li>
                            <li><a href="" title="Instagram"><img src="/welcome/images/clients/instagram.png" alt="clients"></a></li>
                            <li><a href="" title="Converse"><img src="/welcome/images/clients/converse.png" alt="clients"></a></li>
                        </ul>
                    </div> <!-- end Col -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <a class="navbar-brand logo" href="index.html">
                            Techno<span class="text-custom">C</span>oup
                        </a>
                    </div>
        ...
        <!-- Jquery easing -->                                                      
        <script type="text/javascript" src="/welcome/js/jquery.easing.1.3.min.js"></script>

        <!-- Owl Carousel -->                                                      
        <script type="text/javascript" src="/welcome/js/owl.carousel.min.js"></script>

        <!--sticky header-->
        <script type="text/javascript" src="/welcome/js/jquery.sticky.js"></script>

        <!--common script for all pages-->
        <script src="/welcome/js/jquery.app.js"></script>
